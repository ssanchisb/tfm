...
sns.heatmap(avg_fa_ms_edss, cmap='RdYlGn', cbar=True, square=False, mask=None, ax=ax[0])
ax[0].xaxis.tick_top()
ax[0].set_title("MS avg FA Matrix")
...
sns.heatmap(avg_fa_hv, cmap='RdYlGn', cbar=True, square=False, mask=None, ax=ax[1])
ax[1].xaxis.tick_top()
