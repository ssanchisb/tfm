...
# In this script we will normalize the structural and functional matrices
...
# Load the structural and functional matrices
...
# structural matrices normalization
...
# Print the resulting outliers and their count
...
normalized_func_matrices = [((df - df.min().min()) / (max_value_func - df.min().min())).clip(upper=1) for df in
                            func_matrices]
